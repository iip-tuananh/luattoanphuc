          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <image-upload v-model="objData.image" type="avatar" :title="'blog-title'"></image-upload>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Bài viết liên quan đến dịch vụ</label>
                <vs-select class="selectExample"
                  v-model="objData.service_id"
                  placeholder="Dịch vụ">
                  <vs-select-item
                    value="0"
                    text="Không dịch vụ"
...
export default {
  ...
  watch: {},
  methods: {
    ...mapActions(["addBlog", "loadings","listCateBlog","detailBlog","listLanguage","listTypelog","findTypeCateBlog","listCate","listService"]),
    addBlogs(){
      this.errors = [];
      ...
      if(this.objData.category == '') this.errors.push('Chọn danh mục bài viết');
  ...
  mounted() {
    ...
    this.listService().then((response) => {
      this.loadings(false);
