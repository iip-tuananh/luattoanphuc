        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Bộ câu hỏi liên quan</label>
                <vs-select
                  class="selectExample"
                  v-model="objData.pro_cate_id"
...
export default {
  ...
  watch: {},
  methods: {
    ...mapActions(["addService", "loadings","detailService","listLanguage","listCate"]),
    addServices(){
      this.errors = [];
