      ...
      <div class="row flex-row space-30">
         <div class="col-md-4 col-sm-6 col-xs-12 flex-column">
            <div class="box-about text-justify" style="background-color: #009ab1">
               <h3>TẦM NHÌN</h3>
               <p>- Xây dựng Công ty luật TNHH HTC Việt Nam trở thành công ty luật hàng đầu Việt Nam, có uy tín trong cả khu vực và ngoài thế giới. </p>
               ...
               <p>- Chú trọng đến sự phát triển của từng cá nhân để xây dựng tinh thần đoàn kết vững chắc trong môi trường HTC, là nền tảng để mỗi cá nhân phát triển toàn diện về kỹ năng và cuộc sống tại Công ty.</p>
            </div>
         </div>
         <div class="col-md-8 col-sm-6 col-xs-12 flex-column">
            <div class="box-about text-justify" style="background-color: #004fb6">
               <h3>SỨ MỆNH HTC VIỆT NAM</h3>
      ...
      <div class="row flex-row">
         <div class="col-md-4 col-sm-6 col-xs-12 flex-column">
            <div class="box-about text-justify" style="background-color: #87378e">
               <h3>HTC VIỆT NAM HƯỚNG ĐẾN VIỆC TẠO RA SỰ KHÁC BIỆT VÀ NỖ LỰC KHÔNG NGỪNG.</h3>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 flex-column">
            <div class="box-about text-justify" style="background-color: #59b337">
               <h3>GIÁ TRỊ CỐT LÕI HTC VIỆT NAM</h3>
               <p>Với phương châm mang đến cho khách hàng “Hạnh phúc – Thành công – Cường thịnh”, HTC Việt Nam hướng đến xây dựng và phát triển những giá trị cốt lõi:</p>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 flex-column">
            <div class="box-about text-justify" style="background-color: #106cb1">
               <h3>TUYỂN DỤNG</h3>
               <p>Với tinh thần khởi nghiệp nhằm tạo ra một môi trường thoải mái, năng động và giàu sáng tạo, tại HTC Việt Nam luôn mở ra những cơ hội mới để chào đón các ứng viên tiềm năng, sinh viên luật, người tập sự gia nhập đại gia đình HTC .</p>
            </div>
         </div>
      </div>
   </div>
