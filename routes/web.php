...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('dang-ki-dich-vu.html','PageController@dangKiDichVu')->name('dangKiDichVu');
    Route::get('luat-su/{slug}.html','PageController@luatSu')->name('chiTietLuatSu');
    Route::get('tat-ca-cau-hoi-dap.html','ProductController@allProduct')->name('allProduct');
